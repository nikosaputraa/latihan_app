    ...
    <div class="container">
        ...
        <div class="top">
            <div class="navigation"> <a href="#" id="selected">home</a> <a href="#">the journey</a> <a
                    href="#">characters</a> <a href="#">image gallery</a> <a href="#">history</a> </div>
        ...
        <div class="content">
            ...
            <div class="item">
                ...
                <div class="body">
                    ...
                    <p>Aliquam risus justo, mollis in, laoreet a, <a href="#">consectetuer nec</a> risus. Nunc blandit
                        sodales lacus. Nam luctus semper mi. Sed sodales nisl sit amet augue. Donec ultrices, augue
                        ullamcorper posuere laoreet, turpis massa tristique justo.</p>
                </div>
            </div>
            <div class="divider"><span></span></div>
            <div class="item">
                ...
                <div class="body">
                    <p>Integer porta. Fusce nibh. Curabitur pellentesque, lectus at <a href="#">volutpat interdum</a>.
